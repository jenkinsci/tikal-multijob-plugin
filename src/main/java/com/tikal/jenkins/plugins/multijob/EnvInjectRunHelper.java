...
public class EnvInjectRunHelper {
    ...
    public static Map<String, String> getBuildVariables(@NonNull Run<?, ?> run, @NonNull EnvInjectLogger logger)
    ...
    @NonNull
    public static Map<String, String> getEnvVarsPreviousSteps(@NonNull Run<?, ?> build, @NonNull EnvInjectLogger logger)
    ...
    @NonNull
    public static Map<String, String> getJenkinsSystemEnvVars(boolean forceOnMaster)
            throws IOException, InterruptedException {
